        ...
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                foreach (char signo in cadaSigno)
                {
                    ...
                    {
                        if (signo == 'X')
                            Console.WriteLine("Felicitaciones. Ha ganado {0}", nomDos);
                        else
                            Console.WriteLine("Felicitaciones. Ha ganado {0}",nomUno);
                ...
                {
                    if(jugador==1)
                    Console.WriteLine("\nJugador {0}: Por favor elija un casillero...", nomUno);
                    else
                    Console.WriteLine("\nJugador {0}: Por favor elija un casillero...", nomDos);
                    try
                    {
